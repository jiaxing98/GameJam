...
public class AudioManager : MonoBehaviour
{
	...
	public static void PlayDeathAudio()
	{
		...
		Instance.stingSource.clip = Instance.deathStingClip;
	...
	public static void PlayOrbCollectionAudio()
	{
		...
		Instance.stingSource.clip = Instance.orbStingClip;
		Instance.stingSource.Play();
	...
	public static void PlaySceneRestartAudio()
	{
		...
		Instance.stingSource.clip = Instance.levelStingClip;
		Instance.stingSource.Play();
	}
	...
	public static void PlayDoorOpenAudio()
	{
		...
		Instance.stingSource.clip = Instance.doorOpenStingClip;
		Instance.stingSource.PlayDelayed(1f);
	}
	...
	public static void PlayWonAudio()
	{
		...
		Instance.voiceSource.clip = Instance.winVoiceClip;
		Instance.voiceSource.Play();

		//Set the player won sting clip and tell the source to play
		Instance.stingSource.clip = Instance.winStingClip;
		Instance.stingSource.Play();
	}
}
